...
Route::group(['middleware' => ['auth:sanctum']], function () {
    Route::group(['prefix' => '/posts'], function () {
        ...
        Route::get('/{post}/unlike', [PostController::class, 'unlike']);
    ...
    Route::group(['prefix' => '/comments'], function () {
        ...
        Route::get('/{comment}/like', [CommentController::class, 'like']);
        Route::get('/{comment}/unlike', [CommentController::class, 'unlike']);
